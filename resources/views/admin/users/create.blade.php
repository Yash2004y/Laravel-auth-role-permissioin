                ...
                <div class="card-body">
                  ...
                  <form class="row g-3" method="POST" action="{{ route('users.store') }}">
                    ...
                    <div class="col-12">
                        ...
                        <input type="email" name="email" placeholder="Email" class="form-control" value="{{old('email')}}" id="email">
                        @error('email')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <x-multi-select :data=$roles textField="name" valueField="name" inputLabel="Select Roles" firstLabelItem="-- Select Roles --" inputId="roles" inputName="roles[]" inputNameText="roles" />
                        @error('roles')
                        <span class="text-danger">{{$message}}</span>
                        @enderror
                    </div>
